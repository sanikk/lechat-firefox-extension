...
var chatgpt_handler = (() => {
  ...
  return {
    async handle_mutation(node) {
      var _a, _b;
      if ((_a = node.matches) == null ? void 0 : _a.call(node, "article")) {
        _handle_node(node);
      } else {
        const articles = (_b = node.querySelectorAll) == null ? void 0 : _b.call(node, "article");
...
//# sourceMappingURL=chatgpt_handler.js.map
