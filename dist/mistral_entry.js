...
quicklinks
  ...
  function _gather_checked_articles() {
    ...
    const prompt_divs = checkboxes.map((checkbox) => {
      return checkbox == null ? void 0 : checkbox.parentElement;
    });
    ...
    const results = prompt_divs.map((prompt_item) => {
      ...
      if (!answer_id) return;
      const answer_node = (_a = document.querySelector(`div[id="${answer_id}"]`)) == null ? void 0 : _a.querySelector('[data-message-part-type="answer"]');
...
// src/llm_common.js
function itemize_prompt(article, message_id) {
...
// src/mistral_handler.js
var mistral_handler = /* @__PURE__ */ (() => {
  let seen = /* @__PURE__ */ new WeakSet();
  let last_prompt;
  function _handle_node(node) {
    var _a, _b;
    seen.add(node);
    const role = (_a = node.getAttribute) == null ? void 0 : _a.call(node, "data-message-author-role");
    if (role === "user") {
      const message_id = (_b = node.getAttribute) == null ? void 0 : _b.call(node, "data-message-id");
  ...
  return {
    ...
    async get_answer_by_id(answer_id) {
      var _a;
      return (_a = document.querySelector(`div[id="${answer_id}"]`)) == null ? void 0 : _a.querySelector('[data-message-part-type="answer"]');
    }
  };
})();
var mistral_handler_default = mistral_handler;

// src/mistral_entry.js
(async function() {
  "use strict";
  ...
  const dom_observer = new MutationObserver((mutations) => {
    for (const m of mutations) {
      for (const node of m.addedNodes) {
        ...
        mistral_handler_default.handle_mutation(node);
      }
    }
  });
  ...
  mistral_handler_default.handle_mutation(document.body);
  if ("navigation" in window) {
    window.navigation.addEventListener("navigate", () => {
      mistral_handler_default.reset_page();
      sidebar_default.resetPage();
    });
  }
  ;
})();
//# sourceMappingURL=mistral_entry.js.map
